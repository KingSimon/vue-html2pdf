...
var script = {
  ...
  methods: {
    ...
    savePdf: async function savePdf(event) {
...
var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vue-html2pdf"},[_vm._ssrNode("<section"+(_vm._ssrClass("layout-container",{
			...
			}))+">","</section>",[_vm._ssrNode("<section class=\"content-wrapper\""+(_vm._ssrStyle(null,("width: " + _vm.pdfContentWidth + ";"), null))+">","</section>",[_vm._t("pdf-content")],2)]),_vm._ssrNode(" "),_c('transition',{attrs:{"name":"transition-anim"}},[(_vm.pdfFile)?_c('section',{staticClass:"pdf-preview"},[_c('button',{on:{"click":function($event){if($event.target !== $event.currentTarget){ return null; }return _vm.closePreview()}}},[_vm._v("\n          ×\n        ")]),_vm._v(" "),_c('div',{staticClass:"download-pdf",on:{"click":_vm.savePdf}},[_c('div',{staticClass:"inner"})]),_vm._v(" "),_c('iframe',{attrs:{"src":_vm.pdfFile,"width":"100%","height":"100%"}})]):_vm._e()])],2)};
var __vue_staticRenderFns__ = [];

  /* style */
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-2847d056_0", { source: ".download-pdf[data-v-2847d056]{cursor:pointer;position:absolute;top:8px;right:92px;width:40px;height:40px}.download-pdf .inner[data-v-2847d056]{margin-top:2px;margin-left:2px;width:36px;height:36px;border-radius:50%}.download-pdf .inner[data-v-2847d056]:hover{background:rgba(241,241,241,.1)}.vue-html2pdf .layout-container[data-v-2847d056]{position:fixed;width:100vw;height:100vh;left:-100vw;top:0;z-index:-9999;background:rgba(95,95,95,.8);display:flex;justify-content:center;align-items:flex-start;overflow:auto}.vue-html2pdf .layout-container.show-layout[data-v-2847d056]{left:0;z-index:9999}.vue-html2pdf .layout-container.unset-all[data-v-2847d056]{all:unset;width:auto;height:auto}.vue-html2pdf .pdf-preview[data-v-2847d056]{position:fixed;width:65%;min-width:600px;height:80vh;top:100px;z-index:9999999;left:50%;transform:translateX(-50%);border-radius:5px;box-shadow:0 0 10px #00000048}.vue-html2pdf .pdf-preview button[data-v-2847d056]{position:absolute;top:-20px;left:-15px;width:35px;height:35px;background:#555;border:0;box-shadow:0 0 10px #00000048;border-radius:50%;color:#fff;display:flex;align-items:center;justify-content:center;font-size:20px;cursor:pointer}.vue-html2pdf .pdf-preview iframe[data-v-2847d056]{border:0}.vue-html2pdf .transition-anim-enter-active[data-v-2847d056],.vue-html2pdf .transition-anim-leave-active[data-v-2847d056]{transition:opacity .3s ease-in}.vue-html2pdf .transition-anim-enter[data-v-2847d056],.vue-html2pdf .transition-anim-leave-to[data-v-2847d056]{opacity:0}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__ = "data-v-2847d056";
  /* module identifier */
  var __vue_module_identifier__ = "data-v-2847d056";
  /* functional template */
